  ...
  const handleCalculateDevolution = () => {
    ...
    if (studentName === '') {
      ...
      setReport({
        ...report,
        devolution: `
      “Hola ${studentName} ¿Cómo estás?” “¡Muchas gracias por realizar tu entrega!” “ Felicitaciones por tu pre-entrega! ¡Estás cada vez más cerca de la meta final!" “¡Felicitaciones! Tu entrega alcanzó el nivel de óptima! Has logrado cumplir con todos las
      consignas de manera exitosa superando las expectativas. Continua así!”. A continuación paso a detallar los criterios de evaluación:
      `,
      })
      ...
      setReport({
        ...report,
        devolution: `
      “Hola ${studentName} ¿Cómo estás?” “¡Muchas gracias por realizar tu entrega!” “¡Felicitaciones! Tu entrega alcanzó el nivel de correcto! Has logrado cumplir con la mayoría de las consignas de manera exitosa superando las expectativas. Continua así!”. A continuación paso a detallar los criterios de evaluación:
      `,
      })
      ...
      setReport({
        ...report,
        devolution: `
      “Hola ${studentName} ¿Cómo estás?” “¡Muchas gracias por realizar tu entrega!” “Tu entrega alcanzó el nivel de bajo! Tu entrega no alcanzó a cumplir con la mayoría de las consignas de manera exitosa. Te recomiendo que repases los contenidos y vuelvas a intentarlo!” "Animó a no bajar los brazos y seguir intentando, este es un proceso de aprendizaje y no de competencia.". A continuación paso a detallar los criterios de evaluación:
      `,
      })
    }
  }
